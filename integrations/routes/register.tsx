...
export const Route = createFileRoute("/register")({
  head: () => ({
    meta: [
      { title: "Create account — NLP Studio" },
      { name: "description", content: "Create your NLP Studio account and start analyzing text with AI." },
    ],
  }),
...
function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 py-16 overflow-hidden">
      ...
      <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-accent/30 blur-3xl animate-float" style={{ animationDelay: "2s" }} />
      ...
      <AuthCard>
        <RegisterForm onSwitch={() => navigate({ to: "/login" })} />
      </AuthCard>
    </div>
  );
}
